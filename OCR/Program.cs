...
namespace CSHttpClientSample
{
    static class Program
    {
        ...
        static string endpoint = @"https://centralus.api.cognitive.microsoft.com/";
        ...
        static async Task MakeOCRRequest(string imageFilePath)
        {
            try
            {
                ...
                string requestParameters = "language=en&detectOrientation=false";
                requestParameters = "mode=Printed";
